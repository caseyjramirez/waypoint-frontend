...
function InfoContent({email, password, confirmPassword, handleEmailChange, handlePasswordChange, handleConfirmPasswordChange, handleSubmit, emailError, passwordError, confirmPasswordError}) {
